...
#-------------------------------------------------------------------------------------------------------------------------------------------------------------
def vector_closeness_centrality(CG, IG):
...
for Gi in Gu:
    ...
    closeness_vector.append(vector_closeness_centrality(CG, IG))
print(closeness_vector)

#f = open("Second_scenary_closeness_Reversetxt.txt", "w")
f = open("Second_scenary_closenesstxt_inverse.txt", "w")
